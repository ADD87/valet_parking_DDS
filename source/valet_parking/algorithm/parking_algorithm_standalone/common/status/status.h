...
#include "proto_convert/error_code_convert.h"  // 独立编译改造
// future.h is corrupted, commenting out for now
...
class Status {
 public:
  ...
  std::string ToString() const {
    ...
    // 独立编译改造：使用 convert 版本的 ErrorCodeToString
    return std::string(ErrorCodeToString(code_)) + ": " + msg_;
  }
